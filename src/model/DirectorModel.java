...
public class DirectorModel {
	...
	public List<Director> consultaDirector(String fecIni, String fecFin){
		...
		try {
			...
			String sql = "select d.* , g.descripcion from director d inner join grado g on d.idgrado = g.idgrado where d.fechaNacimiento between '1990-01-01' and '1995-12-31';";
	...
	public List<Director> listaDirector(){
		...
		try {
			...
			String sql = "select d.* , g.descripcion from director d inner join grado g on d.idgrado = g.idgrado where d.fechaNacimiento";
